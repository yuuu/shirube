...
@test "__shirube_select_worktree: exits 1 with error when git-wt is not installed" {
  create_empty_mock "git"
  set_fzf_output ""

  run __shirube_select_worktree
  assert_failure
  assert_output --partial "git-wt is not installed"
}
...
@test "__shirube_select_worktree: prints 'select' and branch name when worktree is selected" {
  create_empty_mock "git"
  create_empty_mock "git-wt"
...
@test "__shirube_select_worktree: prints 'delete' and branch name on ctrl-r" {
  create_empty_mock "git"
  create_empty_mock "git-wt"
